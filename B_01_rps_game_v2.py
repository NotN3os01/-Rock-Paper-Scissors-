...
def string_checker(question, valid_ans=("yes", "no")):
    ...
    error = f"Please enter a valid option form the following list: {valid_ans}"
...
To begin_ choose the number of rounds (or press <enter> for
infinite mode).
...
if rounds_played >0:
    ...
    # ask user they want to see their game history and output it if requested.
